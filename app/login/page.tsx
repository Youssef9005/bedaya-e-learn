    ...
    <div className="min-h-screen py-12">
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-purple-800 mb-4">تسجيل الدخول</h1>
          <p className="text-purple-700">أهلاً بعودتك! يرجى تسجيل الدخول للوصول إلى حسابك</p>
        </div>
          ...
          <form>
            ...
            <div className="mb-6">
              <div className="flex justify-between items-center mb-2">
                ...
                <Link href="/reset-password" className="text-sm text-purple-600 hover:text-purple-800">
                  نسيت كلمة المرور؟
                </Link>
              </div>
              <div className="relative">
            ...
            <div className="flex items-center mb-6">
              ...
              />
              <label htmlFor="remember" className="mr-2 block text-sm text-purple-700">
                تذكرني
              </label>
            </div>
        ...
        <div className="text-center">
          <p className="text-purple-700">
            ليس لديك حساب؟{" "}
            <Link href="/signup" className="font-semibold text-purple-800 hover:text-pink-600">
              إنشاء حساب جديد
            </Link>
          </p>
        </div>
        ...
        <div className="flex items-center my-6">
          ...
          <span className="mx-4 text-sm text-purple-600">أو</span>
          <div className="flex-grow border-t border-purple-200"></div>
        </div>
        ...
        <div className="space-y-3">
          <button
            type="button"
            className="w-full py-3 px-4 flex items-center justify-center gap-3 bg-white border border-purple-200 rounded-xl hover:bg-purple-50 transition-colors"
          >
            ...
            <span className="text-purple-800">متابعة باستخدام Google</span>
          </button>
        </div>
      </div>
    </div>
